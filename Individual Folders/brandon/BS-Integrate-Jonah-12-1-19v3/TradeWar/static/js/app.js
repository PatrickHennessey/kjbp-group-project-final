...
function createFeaturesMarkers(countryMarkersData) {
  ...
  // Give each feature a popup describing the place and time of the earthquake
   onEachFeature: function(feature, layer) {
    ...
    "<img src='static/data/Flags/"+`${feature.properties.country}`+".png' alt='TradeWar/data/Flags/NONE.png' style='float:right;clear:both'  height='60' width='60'></img>"+ "</p>" + "<br> " +
  ...
  // }
    ...
    pointToLayer: function(feature, latlng){
      ...
      var flag = L.icon({
        ...
        // iconUrl: `../static/data/Flags/${feature.properties.country}.png`,
        iconUrl: `static/data/Flags/${feature.properties.country}.png`,
...
//// Create our map, giving it the streetmap and earthquakes layers to display on load   ////////////////////
    var myMap = L.map("map", {
      ...
      zoom: 3,
      layers: [darkmap, ]  // , earthquakes, earthquakes2015] countryMarkers countriesGDP
    });
