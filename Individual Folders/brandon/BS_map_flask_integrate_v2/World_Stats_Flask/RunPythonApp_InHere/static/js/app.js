  ...
  */
  ...
  function fillit(db_data) ///THIS DOESNT WORK TO COLOR MAP BUT DOES BRING IN JSON
  {
    ...
    for (var d = 0; d < db_data.length; d++) {
      if (db_data[d].balance_rank > 175) {
        colorz = '#49006a';
      }
      if (db_data[d].balance_rank > 150) {
        colorz = '#7a0177';
      }
      if (db_data[d].balance_rank > 125) {
        colorz = '#ae017e';
      }
      if (db_data[d].balance_rank > 100) {
        colorz = '#dd3497';
      }
      if (db_data[d].balance_rank > 75) {
        colorz = '#f768a1';
      }
      if (db_data[d].balance_rank > 50) {
        colorz = '#fa9fb5';
      }
      if (db_data[d].balance_rank > 25) {
        colorz = '#fcc5c0';
      }
      if (db_data[d].balance_rank < 10) {
        colorz = '#fde0dd';
      }
