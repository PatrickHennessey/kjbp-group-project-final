          ...
          displayInfo.update = function (props) {
            ...
            function conflictInfo() {
              ...
              for (var i = 0; i < conflictNames.length; i++) {
                ...
                if (conflictNames[i].country === props.name && temp.length <= 2) {
                  temp.push(conflictNames[i].name_of_conflict)
                };
                if (conflictNames[i].country === props.name && temp2.length < 9) {
                  temp2.push(conflictNames[i].name_of_conflict)
                };
              }
              if (temp2.length > 2) {
                temp = temp2 + "🔥💣🔥";
            ...
            function conflictDead() {
              ...
              for (var i = 0; i < conflictNames.length; i++) {
                ...
                if (conflictNames[i].country === props.name && temp.length <= 2) {
                  temp.push(conflictNames[i].num_deaths_2019)
                };
                if (conflictNames[i].country === props.name && temp2.length < 9) {
                  temp2.push(conflictNames[i].num_deaths_2019)
                };
              }
              if (temp2.length > 2) {
                temp = temp2 + "🔥💣🔥";
            ...
            d3.json(conflicts, function (data) {
                ...
                function conflictLevel() {
                  ...
                  for (var i = 0; i < conflictNames.length; i++) {
                    ...
                    if (conflictZones.includes(layer.feature.properties.name)) {
                      temp2 = 1
                    } else {
                      temp2 = 0
                    };
...
function init() {
  createMap();
  console.log("JS has run init Create Map");
}
